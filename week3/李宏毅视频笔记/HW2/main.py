...
train = np.load('timit_11/train_11.npy')#得到function  obj
train_label = np.load('timit_11/train_label_11.npy')#得到ndarray
test = np.load('timit_11/test_11.npy')#得到function  obj
