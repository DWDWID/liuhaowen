...
class Classifier(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(64, 128, 1, 2)
        self.conv2 = nn.Conv2d(128, 256, 1, 2)
        self.conv3 = nn.Conv2d(256, 512, 1, 2)
        self.conv4 = nn.Conv2d(512, 512, 1, 2)
        self.res1 = nn.Sequential(
            nn.Conv2d(64, 64, 3, 1, 1),  # [64, 128, 128]
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Conv2d(64, 128, 3, 2, 1),  # [128, 64, 64]
            nn.BatchNorm2d(128),
        )
        self.res2 = nn.Sequential(
            ...
            nn.BatchNorm2d(128),
            nn.ReLU(),
            nn.Conv2d(128, 256, 3, 2, 1),  # [256, 32, 32]
            nn.BatchNorm2d(256),
        )
        self.res3 = nn.Sequential(
            ...
            nn.BatchNorm2d(256),
            nn.ReLU(),
            nn.Conv2d(256, 512, 3, 2, 1),  # [512, 16, 16]
            nn.BatchNorm2d(512),
        )
        self.res4 = nn.Sequential(
            ...
            nn.BatchNorm2d(512),
            nn.ReLU(),
            nn.Conv2d(512, 512, 3, 2, 1),  # [512, 8, 8]
            nn.BatchNorm2d(512),
        )
        self.Relu = nn.ReLU()
    ...
    def forward(self, x):
        x = self.layer(x)
        r = x
        x = self.Relu(self.res1(x) + self.conv1(r))
        r = x
        x = self.Relu(self.res2(x) + self.conv2(r))
        r = x
        x = self.Relu(self.res3(x) + self.conv3(r))
        r = x
        out = self.Relu(self.res4(x) + self.conv4(r))
